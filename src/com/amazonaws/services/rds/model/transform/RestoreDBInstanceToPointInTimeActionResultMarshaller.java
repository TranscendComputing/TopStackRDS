...
public class RestoreDBInstanceToPointInTimeActionResultMarshaller implements
		Marshaller<String, RestoreDBInstanceToPointInTimeActionResultMessage> {
	/*
	 * (non-Javadoc)
	 * 
	 ...
	 */
	@Override
	public String marshall(final RestoreDBInstanceToPointInTimeActionResultMessage input)
			 {
		
		final DBInstance dbInst = getDbInstance(input);
		final XMLNode nodeResponse =  new XMLNode(
				RDS_Constants.NODE_RESTOREDBINSTANCETOPOINTINTIMERESPONSE);
		...
		final XMLNode nodeActionResultMessage = QueryUtilV2.addNode(nodeResponse,
				RDS_Constants.NODE_RESTOREDBINSTANCETOPOINTINTIMERESULT);
	...
	public DBInstance getDbInstance(RestoreDBInstanceToPointInTimeActionResultMessage message) {
