...
public class DeleteDBSnapshotActionResultMarshaller implements
		Marshaller<String, DeleteDBSnapshotActionResultMessage> {
	/*
	 * (non-Javadoc)
	 * 
	 ...
	 */
	@Override
	public String marshall(final DeleteDBSnapshotActionResultMessage input)
			 {
		final XMLNode nodeResponse =  new XMLNode(
				RDS_Constants.NODE_DELETEDBSNAPSHOTRESPONSE);
		nodeResponse.addAttr("xmlns", RDS_Constants.AWS_EMR_NAMESPACE);

		final XMLNode nr = QueryUtilV2.addNode(nodeResponse,
				RDS_Constants.NODE_DELETEDBSNAPSHOTRESULT);
	...
	public static void marshalDBSnapshot(XMLNode parent, DeleteDBSnapshotActionResultMessage o) {
